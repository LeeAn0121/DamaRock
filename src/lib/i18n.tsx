...
const dict: Dict = {
  ...
  "settings.notifPermission": { ko: "알림 권한", en: "Notification permission", ja: "通知の許可", zh: "通知权限" },
  "settings.notifPermissionGranted": { ko: "허용됨", en: "Allowed", ja: "許可済み", zh: "已允许" },
  "settings.notifPermissionDenied": { ko: "차단됨 · 브라우저 설정에서 직접 허용해주세요", en: "Blocked · enable it from your browser settings", ja: "ブロック済み・ブラウザ設定から許可してください", zh: "已屏蔽 · 请在浏览器设置中手动允许" },
  "settings.notifPermissionUnsupported": { ko: "이 브라우저는 지원하지 않아요", en: "Not supported in this browser", ja: "このブラウザでは利用できません", zh: "此浏览器不支持" },
  "settings.notifPermissionIOS": { ko: "iOS에서는 홈 화면에 추가한 뒤에만 알림을 받을 수 있어요", en: "On iOS, notifications only work after adding to your home screen", ja: "iOSではホーム画面に追加した後のみ通知を受け取れます", zh: "在 iOS 上，仅添加到主屏幕后才能接收通知" },
  "settings.enableNotifButton": { ko: "알림 허용하기", en: "Enable notifications", ja: "通知を許可する", zh: "允许通知" },
  ...
  "app.updateAvailable": { ko: "새로운 버전이 있어요", en: "A new version is available", ja: "新しいバージョンがあります", zh: "有新版本可用" },
  "app.updateNow": { ko: "업데이트", en: "Update", ja: "更新", zh: "更新" },
  "app.enableNotif": { ko: "새 항목·댓글 알림을 받아보세요", en: "Get notified about new items and comments", ja: "新しい項目・コメントの通知を受け取りましょう", zh: "接收新项目和评论的通知" },
  "app.allow": { ko: "허용", en: "Allow", ja: "許可", zh: "允许" },
  "app.iosInstallForNotif": { ko: "iOS에서 알림을 받으려면 홈 화면에 추가해주세요", en: "Add to your home screen to get notifications on iOS", ja: "iOSで通知を受け取るにはホーム画面に追加してください", zh: "在 iOS 上，添加到主屏幕才能接收通知" },
