...
const INVITE_CODE = "742-819";

export default function FamilyInvite({ onBack }: { onBack: () => void }) {
  ...
  const copyCode = async () => {
    try {
      ...
      // clipboard permission unavailable — code is still visible to copy manually
    }
    setCopied(true);
      ...
      <div className="mx-auto flex min-h-dvh w-full max-w-md flex-col">
        ...
        <main className="flex-1 overflow-y-auto px-4 pb-10 pt-3">
          ...
          <section className="rounded-2xl bg-surface p-5 text-center shadow-[0_1px_2px_rgba(20,20,10,0.04),0_10px_28px_-14px_rgba(20,20,10,0.18)]">
            ...
            <p className="mt-2 text-4xl font-bold tracking-[0.08em] text-primary">{INVITE_CODE}</p>
          ...
          <section className="mt-6">
            ...
            <div className="rounded-2xl border border-border/60 bg-surface">
              <div className="flex items-center gap-3 px-4 py-3">
                ...
                <span className="flex-1">
                  <span className="block text-base text-foreground">할머니</span>
